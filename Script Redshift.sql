...
CREATE TABLE "licasa"."dim_proveedor"
	("proveedor_key" BIGINT GENERATED BY DEFAULT AS IDENTITY(1,1) NOT NULL encode az64,
...
/*Creacion de registros para asignar cuando alguna FK este vacia*/
INSERT INTO "licasa"."dim_proveedor" ("proveedor_key","proveedor_id","proveedor_nombre") VALUES (-99,'ND','NO DEFINIDO');
